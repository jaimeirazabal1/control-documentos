<form action="" id="form-documento" method="POST" style="margin-top:100px">
	<textarea name="article-body" style="height: 1000px;width:90%;margin:auto">
		...
		<span id="contenido" contenteditable="true" class="cke_editable cke_editable_inline cke_contents_ltr cke_show_borders"> (aqui va el contenido)</span>
